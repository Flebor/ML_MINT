...
# Apply SMOTE sampling to address class imbalance on the train dataset
#dup_size <- sum(data[,"Churn.Value"]) / nrow(data)          # Amount of undersampling
